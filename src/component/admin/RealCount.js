      ...
      {screenSize.width >= 350 && screenSize.width <= 950 ? (
        <>
          ...
          <div className="pt-[20px] px-[16px] pb-[77px] text-[#374151]">
            ...
            <div className={`${user === "koordinator" && "hidden"} bg-[#E44700] cursor-pointer flex justify-center items-center gap-2 py-3 mt-[18px] rounded-sm`}>
          ...
          {user === "Relawan" ? (
            <>
              ...
              <div className="p-8 ml-2">
                ...
                <div className={`${roles === "koordinator" || (roles === "ketua_tim" && "hidden")} flex my-4 gap-3 `}>
