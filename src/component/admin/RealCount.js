...
const RealCount = ({ user }) => {
  ...
  useEffect(() => {
    ...
    axiosFetch(
      "get",
      `user/real_count/total_suara_masuk${
        id_kabupaten !== null ? "?id_kabupaten=" + id_kabupaten : ""
      }`,
      {},
      token
    )
          ...
          <div className="pt-[20px] px-[16px] pb-[77px] text-[#374151]">
            ...
            <div className="flex items-center gap-2 mt-[21px]">
              <div className="w-full bg-[#FFECE4] h-[16px]">
                <div
                  className={`bg-gradient-to-r from-[#FF5001] to-[#FF50016E] w-[60%] h-[15px]`}
                ></div>
              </div>
            ...
            <div
              ...
              } bg-[#E44700] cursor-pointer flex justify-center items-center gap-2 py-3 mt-[18px] rounded-sm`}
            >
            ...
            <div
              ...
              className={`${
                user === "koordinator" && "hidden"
              } py-3 mt-2 text-center px-4 rounded-sm cursor-pointer text-[#374151] font-medium border border-[#374151]`}
            >
              Histori Upload
            </div>
            <p className="mt-[50px] text-[18px] text-[#374151] font-bold">
                      ...
                      res === undefined ? (
                        ...
                        >
                          <div className="flex gap-3">
                            ...
                            />
                            <p className="text-[16px] w-[400px] flex items-center font-semibold text-[#374151]">
                              {res?.name}
                            </p>
                          </div>
                  ...
                  <div className="border-b-[0.5px]">
                    {dataCalon?.data.map((res, i) =>
                      res === undefined ? (
                        ...
                        <div
                          key={res._id}
                          className={`flex w-[700px] items-center ${
                            i === 0 && "border-[0.5px] border-[#FF5001]"
                          } py-1 border-t-[0.5px]`}
                        >
                          <div
                            className={`w-[80px] text-center text-[21px] ${
                              i === 0 ? "text-[#FF5001]" : "text-[#374151]"
                            } font-bold`}
                          >
                            {res.persantase_suara.toFixed(0)} %
                          </div>
                          <div>
                            <img
