    ...
    <>
      {mobile === true ? (
        <div className="flex flex-col gap-2 pt-8">
          <div className="flex items-center p-2 gap-2 w-full h-[60px] text-slate-700 stroke-slate-700 border border-[#FF5001] rounded-sm">
            <PendudukIcon />
            <div>
              <p className="text-[21px] font-bold text-[#FF5001]">{getStatistik.data !== undefined && getStatistik?.data?.jumlah_penduduk}</p>
          ...
          <div className="flex items-center p-2 gap-2 w-full h-[60px] text-slate-700 stroke-slate-700 border border-[#FF5001] rounded-sm">
            <PendudukIcon />
            <div>
              <p className="text-[21px] font-bold text-[#FF5001]">{getStatistik.data !== undefined && getStatistik?.data?.jumlah_dpt_dps}</p>
          ...
          <div className="flex items-center p-2 gap-2 w-full h-[60px] text-slate-700 stroke-slate-700 border border-[#FF5001] rounded-sm">
            <PendudukIcon />
            <div>
              <p className="text-[21px] font-bold text-[#FF5001]">{getStatistik.data !== undefined && getStatistik?.data?.jumlah_tps}</p>
