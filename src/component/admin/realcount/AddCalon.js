            ...
            >
              ...
              <div className="flex mt-[18px]">
                ...
                <input
                  ...
                  onChange={(e) => {
                    nama === undefined
                      ? setFormPartai({ ...formPartai, name: e.target.value })
                ...
                <>
                  <div className="flex justify-end mt-[29px] mb-[49px]">
                    ...
                    <div
                      ...
                      className="h-[42px] w-[42px] flex items-center justify-center ml-2 rounded-md border border-[#B91C1C] cursor-pointer"
                    >
