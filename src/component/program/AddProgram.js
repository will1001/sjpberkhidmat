...
const AddProgram = () => {
  ...
  //   const submitArtikel = () => console.log("tes");
      ...
      <div className="flex pb-[96px]">
        ...
        <div className="basis-4/12  pt-[34px] pl-[50px] pr-[41px] border-l-2">
          ...
          <div className="flex items-center gap-4">
            <div
              //   onClick={() => setFormProgram({ ...formProgram, status: !formProgram.status })}
              className={`w-[56px] h-[30px] cursor-pointer flex items-center px-[2px] rounded-full ${formProgram.status === true ? ` bg-[#FF5001]  justify-end` : "bg-[#6B7280]"}`}
            >
