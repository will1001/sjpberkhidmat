    ...
    <>
      ...
      >
        <div className="w-[260px] h-[48px] bg-slate-700 rounded-sm flex justify-center gap-4 items-center">
          <p className="font-medium text-white text-[16px]">Periode 2019-2024</p> <DropDownIcon />
        </div>
      </button>
      <div
        ...
        <div className="absolute w-[695px] h-[484px] left-[373px] top-[103px] bg-white z-50">
          ...
          >
            <svg width="38" height="39" viewBox="0 0 38 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6 32.5L18 20.5M6 20.5L18 32.5" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>

          <div className="flex flex-col items-start pt-6 pl-12">
            <p className="font-bold text-[32px] text-slate-700">Pilih Periode</p>
            <div className="mt-8">
              <button onClick={cekListHandler2}>
                {initialPeriode === "2019-2024" ? (
                  <div className="flex gap-4 mb-4">
                    ...
                    <p className="font-medium text-[18px] text-[#FF5001]">2019-2024</p>
                  </div>
                ) : (
                  <div className="flex gap-4 mb-4">
                    <svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="font-medium text-[18px] text-slate-700">2019-2024</p>
                  </div>
                )}
              </button>
            </div>
