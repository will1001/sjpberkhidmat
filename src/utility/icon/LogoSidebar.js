...
import RelawanDash from "../../component/admin/RelawanDash";
import SimpatisanDash from "../../component/admin/SimpatisanDash";
...
export const logoSidebar = [
  { name: "Dashboard", path: "/dashboard", icon: <DashboardIcon />, component: <Dashboard /> },
  { name: "Real Count", path: "/real-count", icon: <RealCountIcon />, component: <RealCount /> },
  ...
  { name: "Relawan", icon: <RelawanIcon />, component: <RelawanDash /> },
  { name: "Simpatisan", icon: <SimpatisanIcon />, component: <SimpatisanDash /> },
];
