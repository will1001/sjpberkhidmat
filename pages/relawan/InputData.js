...
const InputData = () => {
  ...
  const postPlano = async () => {
    ...
    for (const item of suaraCalon) {
      const a = new FormData();
      a.append("id_plano", item.id_plano);
      a.append("id_calon", item.id_calon);
      a.append("jml_suara", item.jml_suara);
        ...
        <div>
          <div className="flex px-[16px] py-[11px] items-center justify-between border-b sticky top-0 bg-white z-50 w-screen">
            ...
            <div className="flex gap-3">
              <div
                onClick={postPlano}
                className="flex text-[13px] bg-[#E44700] stroke-white px-3 py-1 gap-3 items-center rounded-sm cursor-pointer"
              >
                <SubmitIcon />{" "}
              ...
              <div className="py-1 px-3 text-[13px] border rounded-sm border-[#374151] text-[#374151] font-semibold cursor-pointer">
                Draft
              </div>
            </div>
          </div>
          ...
          <div className="flex sticky bottom-0 py-[16px] border-t bg-white">
            <div
              onClick={() => setPage("Plano")}
              className={`w-full flex flex-col items-center ${
                page === "Plano"
                  ? "fill-[#FF5001] text-[#FF5001]"
