    ...
    <>
        ...
        <div className="flex gap-12">
          ...
          <div className="w-[600px]">
            ...
            <p className="text-[16px] text-[#374151]">
              ...
              support Suryadi Jaya Purnama untuk mewakili anda menjadi DPR RI
      ...
      <div className="flex h-[248px] bg-[#FF5001] pt-[32px] w-screen">
        <p className="text-white text-[26px] font-bold pl-[180px] w-full">
          Kami membuka pintu komunikasi yang kondusif dan terbuka untuk menerima
          pesan dan aspirasi dari masyarakat.
        </p>
