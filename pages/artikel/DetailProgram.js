    ...
    <div>
      ...
      <div className="px-[246px] py-[88px]  ">
        <div className="text-[#374151] text-[18px] font-medium flex gap-4">
          Daerah Tujuan Program{" "}
          <span className="text-[#FF5001] font-bold">
            {router.query.kabupaten}
          </span>
        </div>
        <br />
        <div className="text-[#374151] text-[52px] font-bold">
          {router.query.title}
        </div>
        ...
        {["mp4", "mkv"].includes(
          ...
          <div className="flex justify-center h-[458px] ">
            <video className="my-[20px]" controls>
              <source
                src={
                  process.env.NEXT_PUBLIC_BASE_URL_IMAGE + router.query.image
                }
                type="video/mp4"
              />
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: router.query.description }}
        />
      </div>
