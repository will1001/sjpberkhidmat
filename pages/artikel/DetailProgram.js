...
function DetailProgram({ router }) {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center bg-orange-500 h-[100px]">
        <h1 className="font-bold text-2xl text-white">Program</h1>
      </div>
      <div className="p-[100px]">
        <div className="text-5xl font-bold">{router.query.title}</div>
        <br />
        <div>
          Daerah Tujuan Program{" "}
          <span className="text-orange-500 ml-[100px]">
