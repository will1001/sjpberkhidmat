  ...
  const postArtikel = async () => {
    ...
    if (switchPage === "video") {
      ...
      ["png", "jpeg", "jpg"].includes(
        formProgram?.image?.name?.split(".").pop().toLowerCase()
        ...
        <div className="flex pb-[96px]">
          <div className="basis-8/12 bg-[#F9FAFB] pl-[42px] pt-[44px] pr-[60px]">
            <div className="flex flex-col gap-2">
              ...
              <label
                id="title"
                className="text-[#6B7280] text-[16px] font-serif"
              >
                Judul Program
              </label>
              <input
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                >
                  <div
                    className={`${
                      formProgram?.image?.name === undefined
                        ? "hidden"
                        : "visible"
                    }`}
                  >
                    {["png", "jpeg", "jpg"].includes(
                      ...
                      <img
                        src={URL.createObjectURL(formProgram?.image)}
                        alt="preview"
                      />
                    ) : (
