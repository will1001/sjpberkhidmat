...
const DynamicHeader = dynamic(
  () => import("../../src/component/program/TextEditor"),
  {
    ssr: false,
  }
);
    ...
    if (switchPage === "video") {
      ...
      if (changeImage !== undefined) {
        ["png", "jpeg", "jpg"].includes(
          changeImage?.name?.split(".").pop().toLowerCase()
      ...
      <div className="flex pl-[42px] mt-[32px] gap-4 border-b-2">
        <div className="flex justify-between w-full pr-[40px]">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* tombol simpan draft */}
            <div
              onClick={postDraftArtikel}
              className="flex cursor-pointer py-[7px] px-4 items-center border border-[#374151] rounded-md text-[#374151] text-[18px] font-semibold"
            >
              Simpan Draft
            </div>
            <div
              onClick={() => Router.back()}
              className="flex border cursor-pointer border-[#B91C1C] text-[#B91C1C] text-[18px] font-semibold px-4 rounded-md  h-[42px] justify-center items-center"
            >
              Batal
            </div>
          </div>
      ...
      <div className="flex pb-[96px]">
        <div className="basis-8/12 bg-[#F9FAFB] pl-[42px] pt-[44px] pr-[60px]">
          <div className="flex flex-col gap-2">
            ...
            <label
              id="title"
              className="text-[] text-[16px] font-serif pt-[60px]"
            >
              detail Program
            </label>
            <div className="flex gap-3 text-[#6B7280] text-[16px]">
              <p
                onClick={() => setSwitchPage("artikel")}
                className={`p-2 ${
                  switchPage === "artikel" &&
                  "text-white bg-[#E44700] rounded-md font-medium"
                } cursor-pointer`}
              >
                Publikasi Artikel
              </p>
              <p
                onClick={() => setSwitchPage("video")}
                className={`p-2 ${
                  switchPage === "video" &&
                  "text-[white] font-medium bg-[#E44700] rounded-md"
                } cursor-pointer`}
              >
                Publikasi Video
              </p>
            ...
            {switchPage === "artikel" ? (
              ...
              <div>
                ...
                {videoPreview !== undefined ? (
                  <>
                    {" "}
                    {switchPage === "video" && formProgram.video !== null && (
                      <iframe
                        width="420"
                        height="315"
                        src={
                  ...
                  <>
                    {" "}
                    {switchPage === "video" && Router.query.video && (
                      <iframe
                        width="420"
                        height="315"
                        src={
        ...
        <div className="basis-4/12  pt-[34px] pl-[50px] pr-[41px] border-l-2">
          <div className="flex flex-col gap-2">
            ...
            <div
              className={`${switchPage === "artikel" ? "visible" : "hidden"}`}
            >
                  ...
                  <>
                    ...
                    <div>
                      {["png", "jpeg", "jpg"].includes(
                        ...
                        <p className="text-[18px] text-red-500 font-bold bg-slate-200 px-4 py-12 flex justify-center">
                          {switchPage === "artikel" ? (
                            <>Type File Harus "JPG, JPEG, PNG" </>
                          ) : (
                            <>Type File Harus "MP4, MKV" </>
                          )}
                        </p>
                      )}
                    </div>
