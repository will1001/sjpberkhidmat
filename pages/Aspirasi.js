...
const Aspirasi = () => {
  ...
  return (
    <>
      <img
        className="w-[463px] h-[1024px] fixed right-0"
        src={aspirasiImage.src}
        alt="rumah_aspirasi.png"
      />
      <div className="pl-[100px] mr-[550px] pt-[65px] pb-[150px]">
        <div className="flex ">
          <div
            onClick={() => router.back()}
            className="flex h-[32px] gap-2  items-center px-4 rounded-sm cursor-pointer border border-[#E44700]"
          >
        ...
        <div className="flex items-center justify-between mt-[45px]">
          ...
          <p className="text-[#374151] text-[26px] font-bold">
            ...
            <br /> <span className="text-[#E44700]">SJP Berkhidmat</span> untuk
            Indonesia
          </p>
        </div>
        <div className="mt-[58px] flex flex-col gap-2 text-[#374151] pb-[150px]">
          ...
          <div className="flex justify-between items-center">
            ...
            <input
              ...
              className="border h-[48px] w-[479px] px-2 outline-0 rounded-md"
              type={"text"}
            />
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <select
              onChange={(e) => changeDesa(e.target.value)}
              className="border h-[48px] w-[479px] px-2 outline-0 rounded-md"
              type={"text"}
            >
          ...
          <div className="flex justify-between items-center">
            <label>Desa</label>
            <select
              onChange={(e) => setForm({ ...form, id_desa: e.target.value })}
              className="border h-[48px] w-[479px] px-2 outline-0 rounded-md"
              type={"text"}
            >
          ...
          <div className="flex justify-between">
            ...
            <textarea
              ...
              className="border h-[179px] w-[479px] px-2 py-2 outline-0 rounded-md"
              type={"text"}
            />
          </div>
          <div className="flex gap-[110px]">
            ...
            {preview === undefined ? (
              <label
                htmlFor="file_upload"
                className="h-[112px] border rounded-md border-[#D1D5DB] cursor-pointer"
              >
                ...
                <div className="flex justify-center mt-4 ">
                  <div>
                    <div className="flex justify-center items-center my-4 ">
                      <p
                        onClick={() => setPreview()}
                        className="h-[42px] cursor-pointer bg-[#FF5001] rounded-md flex px-4 text-white font-medium items-center"
                      >
                        ReUpload
                      </p>
                    </div>
          ...
          {error === true && (
            <div className={`w-full flex  justify-center`}>
              <p
                className={` text-[18px] flex items-center font-medium border border-[#B91C1C] h-[42px] px-4 rounded-sm text-[#B91C1C]`}
              >
                {errorMessage}
              </p>
            </div>
          ...
          {success === true && (
            <div className="w-full flex justify-center ">
              <p className="flex flex-col items-center text-[18px] bg-[#FF5001] p-4 rounded-md text-white font-medium">
                ...
                <span
                  className="text-[16px] italic font-normal underline cursor-pointer"
          ...
          <div className="flex w-full justify-end  mt-[37px]">
            <p
              onClick={postAspirasi}
              className="h-[42px] bg-[#FF5001] flex items-center rounded-md px-4 cursor-pointer text-white font-medium"
            >
              Sampaikan Aspirasi
            </p>
          </div>
