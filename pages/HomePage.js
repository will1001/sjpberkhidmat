  ...
  return (
    <>
      <div
        ...
        } absolute w-[1350px] h-[4750px] mt-[650px] z-10 bg-opacity-50 bg-slate-600 `}
      ></div>
      <div className="w-[1350px] ">
        <div className="flex bg-white w-full h-[72px] px-20 justify-between z-20">
          ...
          <div className="flex items-center gap-4 text-[16px] font-medium text-[#374151]">
            ...
            >
              <span
                className={dropDownPublikasi === false ? "" : "text-[#FF5001] "}
              >
                Publikasi
              </span>{" "}
              <DropDownIcon />
          ...
          <div className="flex items-center justify-center gap-6 px-12 rounded-xl mx-auto mt-[55px] h-[137px] bg-[#FF5001]">
            ...
            <p>
              ...
              <span className="text-white text-[18px]">
                Consequat quis semper enim enim massa augue.
              </span>
            </p>
            <CountDown />
          </div>
        ...
        <div
          className="flex pl-[690px] pb-[81px] gap-8 items-end h-[408px]  bg-cover bg-no-repeat"
        ...
        <div className="bg-[#4B5563] h-[1684px] pt-[67px] px-[120px] flex flex-col items-center">
          ...
          <div className="flex justify-between w-full mb-[21px]">
            ...
            <div className="flex items-center">
              ...
              <select
                className="w-[214px] h-[40px] rounded-md outline-0 pl-2 pr-8 text-[14px] text-slate-800 font-semibold"
                id="kota"
              >
        ...
        <div className="flex h-[248px] bg-[#FF5001] pt-[65px]">
          ...
          <div className="pr-[144px] w-full ml-[39px]">
            ...
            <button className="w-[230px] h-[48px] bg-white text-slate-700 text-[18px] font-bold mt-6">
              Sampaikan Aspirasi
            </button>
          </div>
        </div>
