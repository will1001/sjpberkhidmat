  ...
  return (
    <>
      <div className="w-[1350px] ">
        <div className="fixed top-0 w-screen border-b-2 z-50 shadow-md">
          <div className="flex bg-white w-full h-[72px] px-20 justify-between z-20">
            ...
            <div className="flex items-center gap-4 text-[16px] font-medium text-[#374151]">
              ...
              <p
                onClick={() => goto(refPublikasi.current)}
                className={`flex cursor-pointer ${
                  dropDownPublikasi === false
                    ? "stroke-[#374151]"
                    : "stroke-[#FF5001] "
                } `}
              >
              ...
              <p
                onClick={() => goto(refPendaftaran.current)}
        ...
        <div
          className={`${
            dropDownPublikasi === false ? "hidden" : "visible"
          } mt-12 flex`}
        >
          <DropDownPublikasi />
        </div>
        ...
        <div className="flex flex-col bg-[#ffece4] pb-[118px] w-screen">
          <div className="flex items-center justify-center gap-6 px-12 rounded-xl mx-auto mt-[55px] h-[137px] bg-[#FF5001]">
            <img
              className="object-cover  h-[92px]  rounded-2xl"
              src="https://i.ibb.co/tpcPypN/Frame-2512.jpg"
              alt="gunakan-hak-pilih"
            />
            <p>
              <span className="font-bold text-white text-[26px]">
                Ayo Gunakan Hak Pilih Anda
              </span>
              <br />
              <span className="text-white text-[18px]">
                17 Agustus 2023 Pemilihan Umum DPR RI
              </span>
            </p>
            <CountDown />
          ...
          <div className="flex px-[50px] justify-between mt-[55px] w-screen">
            <Publikasi
              data={
                getPublikasi?.data?.filter((data) =>
                  ["mp4", "mkv"].includes(
                    data?.image?.split(".").pop().toLowerCase()
                  )
                )[0]
              }
            />
            ...
            <div className="flex flex-col gap-2 font-bold text-slate-700 text-[26px] object-contain">
              <p className="mb-2 flex items-center justify-between">
                ...
                <span
                  ...
                  className="text-[16px] text-[#FF5001] font-normal underline cursor-pointer"
                >
                  Lihat Semua
                </span>
              </p>
        ...
        <div
          className="flex pb-[82px] gap-8 items-end h-[408px] w-screen bg-cover bg-no-repeat"
        ...
        <div className="flex pt-[103px] pl-[70px] pr-[70px] w-screen justify-between gap-[80px]">
          <div className="w-screen">
            <p className="text-[26px] text-slate-700 font-bold pb-[40px]">
              Kabar SJP Berkhidmat
            </p>
            {getPublikasiArt?.data
              ...
              .map((res, index) => (
                <div key={res?._id}>
                  {index <= 5 && <KabarSjpBerkhidmat data={res} />}
                </div>
              ))}
          </div>
          <div className="">
            ...
            {banner?.data?.map((res, i) => {
              return (
                <img
                  key={i}
                  className="mt-[47px] w-[350px] h-[300px] rounded-xl"
        ...
        <div className="bg-[#4B5563] h-[1684px] pt-[67px] px-[120px] flex flex-col items-center w-screen">
          <div className="flex items-center  justify-center mb-[60px]">
            <p className="text-[39px] font-bold text-white">
              Program SJP Berkhidmat
            </p>
          </div>
          ...
          {getArtikel?.data?.map((res) => {
            ...
            if (res.publication === true) {
              return (
                <div
                  key={res._id}
                  className="flex w-full h-[144px] border border-[#6B7280] mb-[21px] py-[12px] rounded-md"
                >
                  <div
                    style={{ overflow: "hidden" }}
                    className="py-[10px] pl-[32px] w-full pr-[30px] flex-col gap-1 flex "
                  >
                    <p className="text-[#FF5001] text-[18px] font-semibold">
                      {res?.category}
                    </p>
                    <p className="text-white h-[30px] overflow-y-clip text-[21px] font-bold">
                      {res?.title}
                    </p>
                    <div className="text-white text-[16px]  overflow-y-clip h-[35px] flex">
                      <div
                        className="text-white text-[16px] h-[32px] flex"
          ...
          <div className="flex justify-between w-full items-center mt-[21px]">
            ...
            <div className="flex gap-1">
              ...
              <div className="flex w-[40px] h-[34px] justify-center bg-orange-600 rounded-sm text-white items-center">
                1
              </div>
              <div className="flex w-[40px] h-[34px] justify-center  rounded-sm text-white items-center">
                2
              </div>
              <div className="flex w-[40px] h-[34px] justify-center  rounded-sm text-white items-center">
                3
        ...
        <div className="flex h-[248px] bg-[#FF5001] py-[65px] w-screen px-[50px]">
          <p className="text-white text-[26px] flex font-bold basis-1/2">
            Kami membuka pintu komunikasi yang <br /> kondusif dan terbuka untuk
            menerima <br /> pesan dan aspirasi dari masyarakat.
          </p>
