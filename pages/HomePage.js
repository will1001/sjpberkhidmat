      ...
      <div className="w-[1350px] ">
        <div className="flex bg-[#374151] h-[24px] w-full px-20 justify-between">
          <p className="flex items-center">
            <span className="text-[10px] font-normal text-[#E5E7EB]">
              {" "}
              Official Website&nbsp;
            </span>
        ...
        <div
          className="flex pl-[680px] pb-[62px] gap-8 items-end h-[408px]  bg-cover bg-no-repeat"
        ...
        <div className="bg-[#4B5563] h-[1372px]">
          <p className="text-[39px] font-bold text-white pt-[67px] pl-[70px]">
            Program
          </p>
        </div>
        <div className="flex h-[248px] bg-[#FF5001] pt-[65px]">
          <p className="text-white text-[26px] font-bold pl-[180px]">
            Sampaikan Aspirasi Anda Consectetur ut duis vitae diam tincidunt
            diam quis nec commodo. Mattis elit rhoncus vel
          </p>
          <div className="pr-[144px]">
            <p className="text-[18px] text-white">
              Consectetur ut duis vitae diam tincidunt diam quis nec commodo.
              Mattis elit rhoncus vel parturient{" "}
            </p>
          ...
          <div className="flex  pl-[70px]">
            ...
            <div className="pl-[32px] w-[580px]">
              ...
              <span className="text-[12px] text-[#D1D5DB]">
                ...
                12520, Indonesia <br /> Phone +62 21 7884 2116, Fax +62 21 7884
                6456, E-Mail humas@pks.id <br /> Digital Service Centre (Call
                Centre) PKS +62 21 300 158 88
              </span>
              <hr className="border-t-2 border-[#6B7280] mt-[52px]" />
              <span className="text-[12px] text-[#6B7280]">
                ©2022 INKOR, Indonesia Korea Joint Company
              </span>
            </div>
          </div>
